...
const WEB_DEFAULT_BASE_URL = 'http://localhost:5000';
const NATIVE_DEFAULT_BASE_URL = 'http://192.168.100.5:5000';
const ENV_BASE_URL = process.env.EXPO_PUBLIC_API_URL?.trim();
const IS_WEB_LOCALHOST =
  typeof window !== 'undefined' &&
  (window.location?.hostname === 'localhost' || window.location?.hostname === '127.0.0.1');

const RESOLVED_BASE_URL = ENV_BASE_URL || (IS_WEB_LOCALHOST ? WEB_DEFAULT_BASE_URL : NATIVE_DEFAULT_BASE_URL);

// Global API Configuration
export const API_CONFIG = {
  // Set EXPO_PUBLIC_API_URL to override this automatically resolved URL
  ...
  ENDPOINTS: {
    ...
    PROVIDER_REVIEW_RESPONSE: '/api/provider/reviews/:reviewId/response',
    ...
    ADMIN_REVIEW_RESPONSES_PENDING: '/api/admin/review-responses/pending',
    ADMIN_REVIEW_RESPONSES: '/api/admin/review-responses',
    ADMIN_REVIEW_RESPONSES_MODERATE: '/api/admin/review-responses/:reviewId/moderate',
    ...
    CHATBOT_CHAT_LOCAL: '/api/chatbot/chat-local',
    CHATBOT_ANALYZE_IMAGE_LOCAL: '/api/chatbot/analyze-image-local',
  }
};
